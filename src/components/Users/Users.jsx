...
const Users = () => {
    ...
    return (
        <>
            ...
            <div className='bg-gradient-to-tl from-gray-900 via-gray-800 to-gray-700 min-h-screen py-10'>
                ...
                <div className='container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
                    {users?.users?.map((user) => (
                        <div
                            key={user.id}
                            className='bg-gray-800 bg-opacity-60 backdrop-blur-md border border-gray-700 rounded-2xl shadow-lg p-6 flex flex-col items-center transition-transform hover:-translate-y-1 hover:shadow-2xl'
                        >
                            <img
